...
public class FTPUploaderTask extends Task {
     ...
     * @param upDir Path of directory where the whole remote directory will be downloaded and saved.
     */
    public FTPUploaderTask(String parentDir, String currentDir, String upDir, String ftpHostName, String ftpUser, String ftpPassword){
